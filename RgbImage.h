...
public:
   ...
   void* ImageData() const { return (void*)ImagePtr; }
...
#endif // RGBIMAGE_H - See more at: http://www.codemiles.com/c-opengl-examples/read-an-image-bitmap-bmp-file-and-draw-it-as-texture-t7307.html#sthash.FyIoCDIa.dpuf